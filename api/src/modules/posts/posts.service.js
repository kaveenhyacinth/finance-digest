...
import { internalServerException } from '../../lib/exception.util.js';

async function findAllFinnhubPosts() {
  try {
...
async function findAllBlottPosts() {
  const data = await prisma.post.findMany();
  console.log(data);
  return data;
}

async function createBlottPost(post) {
